...
<body>
	...
	<div id="main">
		<div id="main_table1">
				...
				<tr>
					<td><table width="100%" border="1" align="center"
							...
							<tbody>
								<tr>
									<td width="120">学号：</td>
									<td width="220"><%=user.getNumber()%></td>
									<td width="120"><span id="Label1">学生证号：</span></td>
									<td width="220"><span id="lbl_xszh"> </span></td>
									<td colspan="2">手机类型：</td>
									<td width="220"><span id="lbl_TELLX"></span>1</td>
									<td width="220" rowspan="6"><img id="xszp"
								...
								<tr>
									...
									<td><%=user.getName()%></td>
									<td>培养方向：</td>
									<td colspan="2"><span id="lbl_pyfx">1 </span></td>
									<td>手机号码：</td>
									<td width="165"><span id="lbl_TELNUMBER"> 1</span></td>
								</tr>
								<tr>
									<td>曾用名：</td>
									<td><p>
								...
								<tr>
									<td>出生日期：</td>
									<td><%=sdf.format(new Date(user.getBirthday()))%></td>
									<td>毕业中学：</td>
									<td colspan="2">&nbsp;</td>
									<td>父亲姓名：</td>
								...
								<tr>
									<td>学院：</td>
									<td><%=user.getTheClass().getProfession().getCollege().getName()%></td>
									<td>港澳台码：</td>
								...
								<tr>
									...
									<td><%=user.getTheClass().getProfession().getName()%></td>
								...
								<tr>
									<td>行政班：</td>
									<td><%=user.getTheClass().getName()%></td>
			...
			<div>
				<table width="100%" border="0" align="left" bgcolor="#D0E3A1">
					<tr>
